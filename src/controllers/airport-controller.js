...
async function createAirport(req, res) {
    try {
        const airportReqBody = new Object();
        airportReqBody.name = req.body.name;
        airportReqBody.code = req.body.code;
        if (req.body.address !== undefined) {
            airportReqBody.address = req.body.address
        }
        ...
        airportReqBody.cityId = cityId;

        const airport = await AirportService.createAirport(airportReqBody);
